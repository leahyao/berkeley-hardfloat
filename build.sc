...
object hardfloat extends mill.Cross[hardfloatCrossModule]("2.11.12", "2.12.11") 
...
trait CommonModule extends ScalaModule with SbtModule with PublishModule {
  ...
  def moduleDeps = Seq() ++ chisel3Module 
...
class hardfloatCrossModule(crossVersionValue: String) extends CommonModule with PublishModule with BuildInfo { m =>
  ...
  override def buildInfoPackageName = Some("hardfloat")
